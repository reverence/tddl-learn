...
//			if(s1 instanceof ComparableBindVar){
//				return compareTo(((ComparableBindVar)s1).getBindVal(), s2);
//			}
//			if(s2 instanceof ComparableBindVar){
//				return compareTo(s1, ((ComparableBindVar)s2).getBindVal());
//			}
