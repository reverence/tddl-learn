...
//		if(param1 instanceof ComparabBindVar){
//			return remainder(((ComparabBindVar)param1).getBindVal(), param2);
//		}
//		if(param2 instanceof ComparabBindVar){
//			return remainder(param1, ((ComparabBindVar)param2).getBindVal());
//		}
		else {
