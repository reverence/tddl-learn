...
import com.taobao.tddl.client.jdbc.parameter.ParameterHandler;
import com.taobao.tddl.client.jdbc.parameter.ParameterMethod;
import com.taobao.tddl.client.jdbc.parameter.SetArrayHandler;
import com.taobao.tddl.client.jdbc.parameter.SetAsciiStreamHandler;
import com.taobao.tddl.client.jdbc.parameter.SetBigDecimalHandler;
import com.taobao.tddl.client.jdbc.parameter.SetBinaryStreamHandler;
import com.taobao.tddl.client.jdbc.parameter.SetBlobHandler;
import com.taobao.tddl.client.jdbc.parameter.SetBooleanHandler;
import com.taobao.tddl.client.jdbc.parameter.SetByteHandler;
import com.taobao.tddl.client.jdbc.parameter.SetBytesHandler;
import com.taobao.tddl.client.jdbc.parameter.SetCharacterStreamHandler;
import com.taobao.tddl.client.jdbc.parameter.SetClobHandler;
import com.taobao.tddl.client.jdbc.parameter.SetDate1Handler;
import com.taobao.tddl.client.jdbc.parameter.SetDate2Handler;
import com.taobao.tddl.client.jdbc.parameter.SetDoubleHandler;
import com.taobao.tddl.client.jdbc.parameter.SetFloatHandler;
import com.taobao.tddl.client.jdbc.parameter.SetIntHandler;
import com.taobao.tddl.client.jdbc.parameter.SetLongHandler;
import com.taobao.tddl.client.jdbc.parameter.SetNull1Handler;
import com.taobao.tddl.client.jdbc.parameter.SetNull2Handler;
import com.taobao.tddl.client.jdbc.parameter.SetObject1Handler;
import com.taobao.tddl.client.jdbc.parameter.SetObject2Handler;
import com.taobao.tddl.client.jdbc.parameter.SetObject3Handler;
import com.taobao.tddl.client.jdbc.parameter.SetRefHandler;
import com.taobao.tddl.client.jdbc.parameter.SetShortHandler;
import com.taobao.tddl.client.jdbc.parameter.SetStringHandler;
import com.taobao.tddl.client.jdbc.parameter.SetTime1Handler;
import com.taobao.tddl.client.jdbc.parameter.SetTime2Handler;
import com.taobao.tddl.client.jdbc.parameter.SetTimestamp1Handler;
import com.taobao.tddl.client.jdbc.parameter.SetTimestamp2Handler;
import com.taobao.tddl.client.jdbc.parameter.SetURLHandler;
import com.taobao.tddl.client.jdbc.parameter.SetUnicodeStreamHandler;
import com.taobao.tddl.client.jdbc.replication.RowBasedReplicationListener;
import com.taobao.tddl.client.jdbc.resultset.DummyTResultSet;
...
public class TPreparedStatement extends RetryableTStatement implements PreparedStatement {
    private static final Log log = LogFactory.getLog(TPreparedStatement.class);

    public TPreparedStatement(SqlDispatcher writeDispatcher, SqlDispatcher readDispatcher) {
    ...
    protected int executeUpdateAndCountAffectRows(String dbSelectorId, String targetSql,
        ...
        if(autoGeneratedKeys != -1){
            actualGeneratedKeys.add(ps.getGeneratedKeys());
        }
        return rows;
    }
            ...
            for (SqlAndTable targetSql : entry.getValue()) {
                ...
                try {
                    ...
                    affectedRows = executeUpdateAndCountAffectRows(dbSelectorID, targetSql.sql,
                            context.getFailedDataSources(), connection, affectedRows, actualGeneratedKeys);
                    long during = System.currentTimeMillis() - start;
                    profileRealDatabaseAndTables(entry.getKey(), targetSql, during);
                } catch (SQLException e) {
    ...
    */
    ...
    /**
     * @param targetSqls: key0:最终数据源ID; value0:{key1:最终数据源上执行的具体表名的SQL; value1:绑定参数列表}
    ...
    protected void sortPreparedBatch(
        ...
        try {
            ...
            //List<ParameterContext> batchedParameters = (List<ParameterContext>) arg;
    ...
    public int[] executeBatch() throws SQLException {
        ...
        /**
         * key: 最终数据源ID; value:最终数据源上执行的使用物理表名的SQL
         * 通过父类的addBatch(String sql)方法，加入到batchedArgs中的sql
         */
