...
public class SumTResultSet extends AbstractTResultSet {
	...
	public SumTResultSet(TStatement statementProxy, List<ResultSet> resultSets) throws SQLException {
			...
			if(data != null) {
				if(sum == null) {
					...
					if(sum instanceof Integer) {
						...
						throw new SQLException("The group function 'SUM' does not supported the type '"+sum.getClass()+"'");
					}
				} else {
