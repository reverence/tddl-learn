 ...
 */
public class TDataSourceKeyWeightRandom {

    private static final Log                  logger             = LogFactory
            .getLog(TDataSourceKeyWeightRandom.class);
    /**
     * 每个组内的数据源的个数；
     */
     ...
     */
    public TDataSourceKeyWeightRandom(String[] weightKeys, int[] weights) {
    ...
    /**
     * Getter method for property <tt>dataSourceNumberInGroup</tt>.
     *
     * @return property value of dataSourceNumberInGroup
     */
    ...
    /**
     * Getter method for property <tt>cachedWeightConfig</tt>.
     *
     * @return property value of cachedWeightConfig
     */
