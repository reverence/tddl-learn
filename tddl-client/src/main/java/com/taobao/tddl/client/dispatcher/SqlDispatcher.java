...
public interface SqlDispatcher extends DatabaseChoicer{
	 ...
	 */
	DispatcherResult getDBAndTables(String sql, List<Object> args) throws TDLCheckedExcption;
	...
	/**
	 * 不解析SQL，直接将SQL路由至默认dbIndex(仅为TGroupDataSource实现)
	 * @return
	 */
	DispatcherResult getDBAndTables();
