...
public class MySQL_ChangeTable_PageNumber_Version extends ChangeMethodCommon{
	...
	protected String getReplacedString(String targetTableName,
		...
		return mySQL_getReplacedString_changeTable_version(targetTableName, replacedObj);
	}
}
