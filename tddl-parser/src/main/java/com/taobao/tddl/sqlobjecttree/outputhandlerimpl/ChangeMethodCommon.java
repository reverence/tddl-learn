...
public abstract class ChangeMethodCommon implements OutputHandler{
	public String handle(String table, List<Object> args,
						 List<Object> modifiableTableName, String originalTable, Number skip,
...
//				needAppendtableName=false;
	...
	protected abstract String getReplacedString(String targetTableName,ReplacableWrapper replacedObj);
	...
	protected static final String getReplacedString_changeTable(String targetTableName,
	...
	private static String getNewIndex(String targetTableName,
									  ReplacableWrapper replacedObj) {
		IndexWrapper wa=(IndexWrapper)replacedObj;
		String temp=wa.getReplacedStr().replace(wa.getOriginalTableName(), targetTableName);
		return temp;
	}
