...
public class MySQL_ChangeTable_Version extends ChangeMethodCommon{

	protected boolean allowChangePageNumber() {
		return false;
	}

	protected String getTable(String table, String originalSql) {
		return table;
	}
	protected String getReplacedString(String targetTableName,
			ReplacableWrapper replacedObj) {
		return mySQL_getReplacedString_changeTable_version(targetTableName,
				replacedObj);
	}
