...
public abstract class AbstractRule {
	...
	*/
	 ...
	 * @return
	 */
	protected  AdvancedParameter getAdvancedParamByParamToken(
			String paramToken) {
	...
	private Comparable<?> getIncreatementValueByString(String[] paramTokens) {
		...
		switch (length) {
			...
			case 2:
				...
				DateEnumerationParameter dateEP = new DateEnumerationParameter(
						Integer.valueOf(fields[0]),calendarFieldType);
