...
public class SimpleTableMapProvider implements TableMapProvider {
	...
	/* (non-Javadoc)
	 * @see com.taobao.tddl.rule.ruleengine.entities.convientobjectmaker.TableMapProvider#getTablesMap()
	 */
...
//		}
		...
		if (doesNotSetTablesNumberForEachDatabases()) {
			...
			try {
				...
				throw new IllegalArgumentException("使用simpleTableMapProvider并且指定了tablesNumberForEachDatabase参数，database的index值必须是个integer数字" +
