 ...
 *
 */
public class CartesianProductCalculator implements Parent,Iterable<SamplingField>,Iterator<SamplingField>{
	/**
	...
	private static final CartesianProductCalculatorElement DEFAULT_CPCE = new CartesianProductCalculatorElement(null,Collections.emptySet());
	/**
	...
	public CartesianProductCalculator(Map<String,Set<Object>> enumeratedMap) {
		...
		List<Set<Object>> enumeratedValuesSetOrderByColumnList= new ArrayList<Set<Object>>(columnList.size());
